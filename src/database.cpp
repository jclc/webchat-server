...
bool insertMessage(sqlite3 *db, long timestamp, const std::string& user, const std::string& content) {
	sqlite3_stmt* res;

	const static std::string query = "INSERT INTO Messages (Timestamp, User, Content) VALUES(?, ?, ?);"
